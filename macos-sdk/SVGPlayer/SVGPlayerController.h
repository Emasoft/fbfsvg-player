// SVGPlayerController.h - Low-level SVG animation controller for macOS
//
...
- (nullable SVGPlayerLayer *)createLayerFromPath:(NSString *)filepath error:(NSError * _Nullable * _Nullable)error;
