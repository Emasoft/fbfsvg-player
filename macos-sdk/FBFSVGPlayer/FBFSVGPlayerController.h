...
- (void)svgPlayerController:(FBFSVGPlayerController *)controller
       didChangePlaybackState:(SVGControllerPlaybackState)newState;
...
/// Called when a subscribed element is touched/clicked
...
- (void)svgPlayerController:(FBFSVGPlayerController *)controller
          didTouchElementWithID:(NSString *)elementID
                    atViewPoint:(NSPoint)viewPoint
                       svgPoint:(NSPoint)svgPoint;
